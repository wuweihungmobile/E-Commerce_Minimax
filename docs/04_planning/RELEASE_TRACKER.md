...
| 已 push（已 Release） | 73 (2026-09-01 確認 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，含 Sprint 102) |
| 待 push（Tag 已建、尚未 push） | 0 |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2030.01.23-01 (Sprint 102，✅ 已 push) |
| 最近一次已 push Release | v2030.01.23-01 (Sprint 102，2026-09-01，雲端 CI 全綠) |
| 最近一次跳過 | Sprint 8-9 |
