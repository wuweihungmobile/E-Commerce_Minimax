...
| 項目 | 數值 |
|------|------|
| 建立 Release Tag 次數 | 74 (Sprint 10~103 中已建 row 者；Sprint 8-9 未正式 Release) |
| 已 push（已 Release） | 73 (2026-09-01 Sprint 103 開工核對 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，含 Sprint 102 的兩筆 commit) |
| 待 push（Tag 已建、尚未 push） | 1 (Sprint 103) |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2030.02.06-01 (Sprint 103，⏳ 待 push) |
