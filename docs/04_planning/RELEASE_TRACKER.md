...
| 已 push（已 Release） | 78 (2026-09-02 Sprint 108 開工核對 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，確認 Sprint 107 的 `97bac42` + `79581e6` 已 push) |
| 待 push（Tag 已建、尚未 push） | 1 (Sprint 108) |
