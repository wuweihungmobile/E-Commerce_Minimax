...
| 項目 | 數值 |
|------|------|
| 建立 Release Tag 次數 | 43 (Sprint 10-52，連續) |
| 已 push（已 Release） | 31 (Sprint 10-40) |
| 待 push（Tag 已建、尚未 push） | 12 (Sprint 41~52，本地各層驗證通過含 validate-schema/validate-e2e；累積後檢查點徵詢+完整 validate-release 後 push) |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2027.10.23-01 (Sprint 52，⏳ 待 push) |
