...
| 已 push（已 Release） | 77 (2026-09-02 Sprint 107 開工核對 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，確認 Sprint 106 的 `042f8c0` 已 push) |
| 待 push（Tag 已建、尚未 push） | 1 (Sprint 107) |
