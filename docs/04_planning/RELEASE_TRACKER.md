...
| 項目 | 數值 |
|------|------|
| 建立 Release Tag 次數 | 77 (Sprint 10~106 中已建 row 者；Sprint 8-9 未正式 Release) |
| 已 push（已 Release） | 76 (2026-09-02 Sprint 106 開工核對 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，確認 Sprint 105 的 `6afe06a` + `b24f458` 已 push) |
| 待 push（Tag 已建、尚未 push） | 1 (Sprint 106) |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2030.02.22-01 (Sprint 106，⏳ 待 push) |
| 最近一次已 push Release | v2030.02.21-01 (Sprint 105，2026-09-02，雲端 CI run 33536341997 / 33538775031 皆全綠) |
| 最近一次跳過 | Sprint 8-9 |
