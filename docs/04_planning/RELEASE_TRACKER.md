...
| 項目 | 數值 |
|------|------|
| 建立 Release Tag 次數 | 78 (Sprint 10~107 中已建 row 者；Sprint 8-9 未正式 Release) |
| 已 push（已 Release） | 79 (2026-09-02 Sprint 109 收尾核對 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，確認 `ef73477` 已 push) |
| 待 push（Tag 已建、尚未 push） | 0 |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2030.02.23-01 (Sprint 107，⏳ 待 push) |
| 最近一次已 push Release | v2030.02.22-01 (Sprint 106，2026-09-02，雲端 CI run 33577203041 全綠) |
| 最近一次跳過 | Sprint 8-9 |
