...
| 項目 | 數值 |
|------|------|
| 建立 Release Tag 次數 | 73 (Sprint 10~102 中已建 row 者；Sprint 8-9 未正式 Release) |
| 已 push（已 Release） | 72 (2026-09-01 開工核對 `git rev-list --left-right --count origin/main...HEAD` = `0 0`，Sprint 101 及以前全數同步) |
| 待 push（Tag 已建、尚未 push） | 1 (Sprint 102) |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2030.01.23-01 (Sprint 102，⏳ 待 push) |
| 最近一次已 push Release | v2030.01.09-02 (Sprint 101，2026-09-01 開工核對已同步；原記載停在 Sprint 100，與同表 Sprint 101 的「✅ 已 push」自相矛盾，一併更正) |
| 最近一次跳過 | Sprint 8-9 |
