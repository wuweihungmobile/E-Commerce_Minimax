...
| 項目 | 數值 |
|------|------|
| 建立 Release Tag 次數 | 72 (Sprint 10~101 中已建 row 者；Sprint 8-9 未正式 Release) |
| 已 push（已 Release） | 71 (Sprint 100 及以前；2026-09-01 確認 origin/main 已對齊 commit 144b219) |
| 待 push（Tag 已建、尚未 push） | 1 (Sprint 101——依「狀態欄維護規則」，於 Sprint 102 開工時回填實際狀態) |
| 跳過 Release 次數 | 2 (Sprint 8-9) |
| 最近一次 Release Tag | v2030.01.09-02 (Sprint 101，⏳ 待 push) |
